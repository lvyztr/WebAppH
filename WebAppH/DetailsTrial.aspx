<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="DetailsTrial.aspx.cs" Inherits="WebAppH.DetailsTrial" %>
    ...
    <table class="auto-style50">
            ...
            <tr>
                ...
                <td class="auto-style74">
                    <asp:TextBox ID="txtTitle" runat="server" Width="186px"></asp:TextBox>
                </td>
                <td class="auto-style75">
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtTitle" ErrorMessage="* Do not leave field blank*" ForeColor="Red"></asp:RequiredFieldValidator>
                </td>
            ...
            <tr>
                ...
                <td class="auto-style74">
                    <asp:TextBox ID="txtcellphone" runat="server" Width="186px"></asp:TextBox>
                </td>
                <td class="auto-style75">
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="txtcellphone" ErrorMessage="*Do not leave field blank*" ForeColor="Red"></asp:RequiredFieldValidator>
                </td>
            ...
            <tr>
                ...
                <td class="auto-style74">
                    <asp:TextBox ID="txtAddress1" runat="server" Width="186px"></asp:TextBox>
                </td>
                <td class="auto-style75">
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ControlToValidate="txtAddress1" ErrorMessage="*Do not leave field blank*" ForeColor="Red"></asp:RequiredFieldValidator>
                </td>
                <td class="auto-style76">Country</td>
                <td class="auto-style77">
                    <asp:DropDownList ID="DropDownList1" runat="server" Height="17px" Width="186px">
            ...
            <tr>
                ...
                <td class="auto-style74">
                    <asp:TextBox ID="txtAddress2" runat="server" Width="186px"></asp:TextBox>
                </td>
                <td class="auto-style75">
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator15" runat="server" ControlToValidate="txtAddress2" ErrorMessage="*Do not leave field blank*" ForeColor="Red"></asp:RequiredFieldValidator>
                </td>
            ...
            <tr>
                ...
                <td class="auto-style80">
                    <asp:TextBox ID="txtAddress3" runat="server" Width="186px"></asp:TextBox>
                </td>
                <td class="auto-style81">
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server" ControlToValidate="txtAddress3" ErrorMessage="*Do not leave field blank*" ForeColor="Red"></asp:RequiredFieldValidator>
                </td>
                <td class="auto-style76">&nbsp;</td>
                <td class="auto-style77">&nbsp;</td>
                <td class="auto-style78">&nbsp;</td>
            ...
            <tr>
                ...
                <td class="auto-style80">
                    <asp:DropDownList ID="DropDownMatricYear" runat="server" Height="22px" Width="186px">
                ...
                <td class="auto-style83">
                    <asp:TextBox ID="txtHighSchool" runat="server" Width="186px" Height="20px"></asp:TextBox>
                </td>
                <td class="auto-style84">
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator13" runat="server" ControlToValidate="txtHighSchool" ErrorMessage="*Do not leave field blank*" ForeColor="Red"></asp:RequiredFieldValidator>
                </td>
            </tr>
            <tr>
                <td class="auto-style79">Name of University</td>
                <td class="auto-style80">&nbsp;<asp:DropDownList ID="DropDownList2" runat="server" CssClass="auto-style40" Height="20px" Width="186px">
                <asp:ListItem>Select</asp:ListItem>
                ...
                <td class="auto-style83">
                    ...
                    <asp:DropDownList ID="DropDownDegree" runat="server" Height="16px" Width="186px">
                        <asp:ListItem>Select</asp:ListItem>
            ...
            <tr>
                ...
                <td class="auto-style80">
                    <asp:DropDownList ID="DropDownStudyField" runat="server" Height="21px" Width="186px">
                        <asp:ListItem>Select</asp:ListItem>
                ...
                <td class="auto-style83">
                    <asp:DropDownList ID="DropDownGraduationDate" runat="server" Width="186px">
                        <asp:ListItem>Select</asp:ListItem>
                    </asp:DropDownList>
                </td>
                <td class="auto-style78">&nbsp;</td>
            ...
            <tr>
                <td class="auto-style56" colspan="6">
                    <asp:Button ID="Button1" runat="server" Text="Submit" Height="50px" style="text-align: left" Width="131px" />
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    &nbsp;</td>
            </tr>
            </table>
